...
public class NCCommands {
	...
	public static final byte COM_PRIVATE = 11;
	public static final byte COM_SOCKET_IN = 101;

	/**
	 * Códigos de los comandos válidos que puede introducir el usuario del shell. El
	 * orden es importante para relacionarlos con la cadena que debe introducir el
	 * usuario y con la ayuda
	 */
	protected static final Byte[] _valid_user_commands = { COM_ROOMLIST, COM_ENTER, COM_NICK, COM_SEND, COM_EXIT,
			COM_ROOMINFO, COM_QUIT, COM_HELP, COM_RENAME, COM_PRIVATE };

	/**
	 * cadena exacta de cada orden
	 */
	protected static final String[] _valid_user_commands_str = { "roomlist", "enter", "nick", "send", "exit", "info",
			"quit", "help", "rename", "private" };

	/**
	 * Mensaje de ayuda para cada orden
	 */
	private static final String[] _valid_user_commands_help = { "provides a list of available rooms to chat",
			"enter a particular <room>", "to set the <nickname> in the server", "to send a <message> in the chat",
			"to leave the current room", "shows the information of the room", "to quit the application",
			"shows this information","to rename the actual name of the room to <name>", "to send to <nickname> a private <message>"
			 };
