...
import es.um.redes.nanoChat.server.roomManager.NCManager;
...
public class NanoChatServer implements Runnable {
	...
	private static final int MYPROTOCOL = 98936627;
    ...
    private NanoChatServer(InetSocketAddress a)
    {
    	...
    	NCManager man = new NCManager();
    	//TODO manager.registerRoomManager();
    	manager.registerRoomManager(man);
    }
